...
change_color() {
	# i3
	sed -i -e "s/\$background \"#.*\"/\$background \"$BG\"/g" $IFILE
	sed -i -e "s/\$foreground \"#.*\"/\$foreground \"$FG\"/g" $IFILE
	sed -i -e "s/\$foreground-alt \"#.*\"/\$foreground-alt \"$FGA\"/g" $IFILE
	sed -i -e "s/\$module-fg \"#.*\"/\$module-fg \"$MF\"/g" $IFILE
	sed -i -e "s/\$primary \"#.*\"/\$primary \"$AC\"/g" $IFILE
	sed -i -e "s/\$secondary \"#.*\"/\$secondary \"$SC\"/g" $IFILE
	sed -i -e "s/\$alternate \"#.*\"/\$alternate \"$AL\"/g" $IFILE
